...
public class MucusCircleGageTimer : MonoBehaviour {
    ...
    // クールダウンを開始するメソッド
    public void MucusUIStartCooldown() {
        print("startCooldown");
    ...
    // クールダウンを停止するメソッド
    public void MucusUIStopCooldown() {
        _isCooldownActive = false;
        _circleGauge.fillAmount = 1f; // クールダウンが手動で停止された場合にゲージを満タンにする
    }
    public void MucusCoolDownFloat(float cooldown) {

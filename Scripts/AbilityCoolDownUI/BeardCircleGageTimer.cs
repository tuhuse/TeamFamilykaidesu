...
public class BeardCircleGageTimer : MonoBehaviour {
    ...
    // クールダウンを開始するメソッド
    public void BeardUIStartCooldown() {
    ...
    // クールダウンを停止するメソッド
    public void BeardUIStopCooldown() {
        _isCooldownActive = false;
        _circleGauge.fillAmount = 1f; // クールダウンが手動で停止された場合にゲージを満タンにする
    }
    public void BeardCoolDownFloat(float cooldown) {
